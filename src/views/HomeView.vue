    ...
    <div class="body" style="margin:0; width:100%; min-width:320px">
        <div class="container">
            ...
            <div class="calorieCheckForm">
                <h3 style="width:100%; position:absolute; margin: 0 auto; top:60%; z-index:1;">
                    ...
                    <span v-if="targetCalories === 0"></span>
                ...
                <ul class="foodList" style=" width:100%; margin:0 auto; padding:0;">
                    ...
                    <ul style="list-style:none; padding:0; background-color:#333333">
                        <li
                            ...
                            style="opacity:0.95; display:inline-block; width:18.5%; height:80px; background-color:#eae7dc; border:1.5px solid #2b2b2b; margin:3px 1px; border-radius:10px; cursor:pointer;"
                        >
                            ...
                            <h5 style="margin:0 auto; padding-top:3px; height:22px; width:90%; background:#333333; border:2px solid #fff; border-radius:10px;">{{ meat.name }}</h5>
                        </li>
                        <li class="foodBox"  @click="addModalIsActive = true" style="opacity:0.95; display:inline-block; width:18.5%; height:80px; background-color:#eae7dc; border:1.5px solid #2b2b2b; margin:3px 1px; border-radius:10px; cursor:pointer;">
                            ...
                            <div class="modalWrapper" v-if="isActive === true && tabNumber === '1'" style="position:fixed; top:0; left:0; z-meatIndex:100; width:100%; height:100%; background-color: rgba(0, 0, 0, 0.6)">
                                <div class="modalWindow" style="position:relative; top:20%; width:90%; height:70%; max-height:350px; background-color:#d8c3a5; margin:0 auto; border-radius:10px;">
                                    ...
                                    <div class="countArea" style="display:flex; padding:5px 15%;">
                                        <button :disabled="meats[meatIndex].count < 100" @click="meats[meatIndex].count -= 100, totalCalorieOfMeats = sumCalorieOfMeats, addCalorie">-100g</button>
                                        <button :disabled="meats[meatIndex].count < 10" @click="meats[meatIndex].count -= 10, totalCalorieOfMeats = sumCalorieOfMeats">-10g</button>
                                    ...
                                    <h3 style="text-decoration:underline;">Total: {{ totalCalories }} kcal</h3>
                                </div>
                            </div>
                        </transition>
                        <transition name="fade" mode="out-in" appear>
                            <div class="modalWrapper" v-if="addModalIsActive === true && tabNumber === '1'" style="position:fixed; top:0; left:0; z-meatIndex:100; width:100%; height:100%; background-color: rgba(0, 0, 0, 0.6)">
                                <div class="modalWindow" style="position:relative; top:20%; width:90%; height:70%; max-height:350px; background-color:#d8c3a5; margin:0 auto; border-radius:10px;">
                                    ...
                                    <br>
                                    <div style="width:90%; margin:0 auto; display:flex; padding-left:10%">
                                        <input type="number" v-model="newItemCalorie" style="height:30px; margin:0 0 0 auto;">
                                        <p style="margin:0 auto 0 0; width:55px; position:relative; padding-top:4px">kcal/g</p>
                                    </div>
                    ...
                    <ul style="list-style:none; padding:0; background-color:#333333">
                        ...
                        >
                            ...
                            <h5 style="margin:0 auto; padding-top:3px; height:22px; width:90%; background:#333333; border:2px solid #fff; border-radius:10px;">{{ vegetable.name }}</h5>
                        </li>
                        <li class="foodBox" @click="addModalIsActive = true" style="opacity:0.95; display:inline-block; width:18.5%; height:80px; background-color:#eae7dc; border:1.5px solid #2b2b2b; margin:3px 1px; border-radius:10px; cursor:pointer;">
                            <img src="@/assets/others/icons8-plus-100.png" style="position:relative; top:10%; width:25px; height:25px; padding:5px 20px; background-color:#fff; border-radius:10px;">
                            <h4 style="margin:0 auto;">Add</h4>
                    ...
                    <li v-else-if="tabNumber === '3'">
                        ...
                        >
                            ...
                            <h5 style="margin:0 auto; padding-top:3px; height:22px; width:90%; background:#333333; border:2px solid #fff; border-radius:10px;">{{ fruit.name }}</h5>
                        </li>
                        <li class="foodBox" @click="addModalIsActive = true" style="opacity:0.95; display:inline-block; width:18.5%; height:80px; background-color:#eae7dc; border:1.5px solid #2b2b2b; margin:3px 1px; border-radius:10px; cursor:pointer;">
                            <img src="@/assets/others/icons8-plus-100.png" style="position:relative; top:10%; width:25px; height:25px; padding:5px 20px; background-color:#fff; border-radius:10px;">
                            <h4 style="margin:0 auto;">Add</h4>
                    ...
                    <li v-else-if="tabNumber === '4'">
                        ...
                        >
                            ...
                            <h5 style="margin:0 auto; padding-top:3px; height:22px; width:90%; background:#333333; border:2px solid #fff; border-radius:10px;">{{ dairy.name }}</h5>
                        </li>
                        <li class="foodBox" @click="addModalIsActive = true" style="opacity:0.95; display:inline-block; width:18.5%; height:80px; background-color:#eae7dc; border:1.5px solid #2b2b2b; margin:3px 1px; border-radius:10px; cursor:pointer;">
                            <img src="@/assets/others/icons8-plus-100.png" style="position:relative; top:10%; width:25px; height:25px; padding:5px 20px; background-color:#fff; border-radius:10px;">
                            <h4 style="margin:0 auto;">Add</h4>
